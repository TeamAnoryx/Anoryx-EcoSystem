...
dashboards, D-011 forecasting, D-012 chargeback/anomaly).

Exposes ``/v1/admin/*`` (allocations, decisions, history, dashboards, forecast,
chargeback) plus a ``/health`` probe. One app/port for the whole admin console
(D-008/D-011/D-012 add routes to the D-007 app rather than standing up a second
