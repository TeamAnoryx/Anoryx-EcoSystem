...
personal-finance, subscriptions, investments, micro-transactions) plus a ``/health``
probe. One app/port for the whole admin console (D-008/.../D-024 add routes to the
