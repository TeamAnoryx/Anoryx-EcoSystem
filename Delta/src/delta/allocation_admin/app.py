...
D-022 subscriptions, D-023 asset-allocation recommendations).
...
personal-finance, subscriptions, asset-allocation) plus a ``/health`` probe. One
app/port for the whole admin console (D-008/.../D-023 add routes to the D-007 app
...
from ..asset_allocation.router import router as asset_allocation_router
