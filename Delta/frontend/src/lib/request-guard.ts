...
/**
 * CSRF defense-in-depth (mirrors Anoryx-Sentinel/frontend/src/lib/request-guard.ts).
 * SameSite=Strict is the primary control; this adds an explicit cross-site
 * rejection on state-changing routes.
 *
