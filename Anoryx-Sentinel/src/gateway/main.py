...
from gateway.routes.audit import tenant_audit_router
...
def create_app() -> FastAPI:
    ...
    # F-012a: tenant self-service audit read (/v1/audit) — tenant Bearer auth.
    app.include_router(tenant_audit_router)
    # F-012a: admin console API (ADR-0014). /admin/* gated by SENTINEL_ADMIN_TOKEN
