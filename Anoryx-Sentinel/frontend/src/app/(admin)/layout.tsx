...
/**
 * Fail-closed server guard for the entire admin route group (ADR-0015 D2, R3,
 * vector 3). No valid session → redirect to /login BEFORE any admin data renders.
 */
    ...
    <div className="min-h-screen">
      ...
      <header className="flex flex-wrap items-center justify-between gap-3 border-b border-border bg-bg-raised px-6 py-3">
        <div className="flex items-center gap-4">
          <span className="font-mono text-sm font-semibold text-fg">Sentinel Admin</span>
          <AppNav />
        </div>
        <LogoutButton />
      </header>
