...
async def test_migrations_reversible():
    ...
    0031, ADR-0025 0032, F-026 0033, F-028 0034). To stay correct regardless of the current head,
    ...
    assert "0034" in (cur.stdout + cur.stderr), "expected head at 0034 before downgrade"
    ...
    assert "0034" in (cur_up.stdout + cur_up.stderr), "expected head at 0034 after re-upgrade"
