...
Migration chain: 0001 -> 0002 -> 0003 -> 0004 -> 0005 -> 0006 -> 0007 (head)
"""
...
def test_current_head_is_0007() -> None:
    """Alembic current should report head at revision 0007 (F-006)."""
...
def test_migration_downgrade_and_reapply() -> None:
    ...
    assert "0007" in result_current.stdout or "0007" in result_current.stderr
...
def test_incremental_downgrade() -> None:
    ...
    """
    num_revisions = 7  # 0001 through 0007
