...
Migration chain: 0001 -> 0002 -> 0003 -> 0004 -> 0005 -> 0006 -> 0007 -> 0008
                 ...
                 -> 0016 -> 0017 -> 0018 -> 0019 -> 0020 -> 0021 (head)
"""
...
def test_current_head_is_0021() -> None:
    """Alembic current should report head at revision 0021 (F-016 CRIT-2 policy_type)."""
    result = _run_alembic("current")
    assert result.returncode == 0, f"alembic current failed:\n{result.stderr}"
    assert "0021" in result.stdout or "0021" in result.stderr
...
def test_migration_downgrade_and_reapply() -> None:
    ...
    assert "0021" in result_current.stdout or "0021" in result_current.stderr
...
def test_incremental_downgrade() -> None:
    ...
    """
    num_revisions = 21  # 0001 through 0021
