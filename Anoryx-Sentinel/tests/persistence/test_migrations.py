...
Migration chain: 0001 -> 0002 -> 0003 -> 0004 -> 0005 -> 0006 -> 0007 -> 0008 (head)
"""
...
def test_current_head_is_0008() -> None:
    """Alembic current should report head at revision 0008 (F-008)."""
...
def test_migration_downgrade_and_reapply() -> None:
    ...
    assert "0008" in result_current.stdout or "0008" in result_current.stderr
...
def test_incremental_downgrade() -> None:
    ...
    """
    num_revisions = 8  # 0001 through 0008
