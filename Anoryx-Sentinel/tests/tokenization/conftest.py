"""Shared fixtures for tests/tokenization/ (F-033).

service.py uses persistence.database engine singletons (get_tenant_session).
Dispose+null them before/after each test — same event-loop isolation fix used
across the suite (mirrors tests/mcp_gateway/conftest.py)."""
