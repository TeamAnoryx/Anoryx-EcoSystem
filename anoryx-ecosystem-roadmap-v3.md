...
- [x] R-025 Premium features + monetization (B2C) 🏦 ✅ (shipped PR #<n>, scoped to a deterministic, fail-closed feature-entitlement seam — two-tier gate model + two compositions over R-022/R-024's already-public limits; no payment processing, no Delta ledger wiring — that remains X-005, see ADR-0025)
