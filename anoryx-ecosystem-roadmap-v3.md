...
- [x] R-026 Creator economy features 🏦 ✅ (shipped PR #<n>, scoped to a deterministic, tier-gated revenue-share allocation seam over R-025's PremiumEntitlement — no payment collection/payout, no follower/content persistence, no Delta wiring; see ADR-0026)
