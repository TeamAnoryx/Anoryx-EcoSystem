...
- [x] R-020 Localized tech-event discovery 🏦 ✅ (shipped PR #107, scoped to a deterministic filter+rank seam over R-013's Event/EventSession, tagged with an opaque exact-match locality label — no geocoding, no "startup" domain (that's Delta's CRM), no persistence, no REST/UI; see ADR-0020)
